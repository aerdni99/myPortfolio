...
main.cpp - Driver code for the whole game. 
...
Character.txt - Contains all the available character customization options

Items.txt - Contains all the items in the game.
